...
new class extends Component {
    ...
    {
        $this->validate(['dashboardUrl' => ['required', 'url', 'max:500']]);
        ...
        $this->dashboardUrl = Webhook::forUser($userId, 'dashboard_chat')?->url ?? $this->dashboardUrl;
    ...
    {
        $this->validate(['rechercheUrl' => ['required', 'url', 'max:500']]);
        ...
        $this->rechercheUrl = Webhook::forUser($userId, 'recherche_start')?->url ?? $this->rechercheUrl;
...
<x-settings.layout :heading="__('Webhooks')" :subheading="__('Weise jedem Frontend-Objekt einen Langdock-Webhook zu')">
    <div class="space-y-6">
        ...
        <div class="rounded-md border border-zinc-200 p-4 dark:border-zinc-700">
            ...
            <form wire:submit="saveDashboard" class="flex flex-col gap-2 sm:flex-row sm:items-start">
                <div class="flex-1">
                    <input
            ...
            <div wire:dirty.remove wire:target="saveDashboard" class="mt-2">
        ...
        <div class="rounded-md border border-zinc-200 p-4 dark:border-zinc-700">
            ...
            <form wire:submit="saveRecherche" class="flex flex-col gap-2 sm:flex-row sm:items-start">
                <div class="flex-1">
                    <input
            ...
            <div wire:dirty.remove wire:target="saveRecherche" class="mt-2">
