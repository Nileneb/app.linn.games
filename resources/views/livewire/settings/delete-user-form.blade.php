...
<section class="mt-10 space-y-6">
    ...
    <button wire:click="openModal" data-test="delete-user-button" class="inline-flex items-center justify-center rounded-md bg-red-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
        {{ __('Delete account') }}
    </button>
        ...
        <div class="relative z-10 w-full max-w-lg rounded-lg border border-zinc-200 bg-white p-6 shadow-xl dark:border-zinc-700 dark:bg-zinc-800">
            <form wire:submit="deleteUser" class="space-y-6">
                ...
                <div class="flex justify-end space-x-2 rtl:space-x-reverse">
                    <button type="button" wire:click="closeModal" class="rounded-md border border-zinc-300 bg-white px-4 py-2 text-sm font-medium text-zinc-700 shadow-sm hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-600">
                        {{ __('Cancel') }}
                    </button>
