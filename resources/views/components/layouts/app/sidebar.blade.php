    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800" x-data="{ sidebarOpen: false }">
        ...
        >
            ...
            <nav class="mt-6 space-y-1">
                ...
                <a href="{{ route('credits.usage') }}" wire:navigate
                   class="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('credits*') ? 'bg-zinc-200/70 text-zinc-900 dark:bg-zinc-700/50 dark:text-zinc-100' : 'text-zinc-700 hover:bg-zinc-200/50 dark:text-zinc-300 dark:hover:bg-zinc-700/30' }}">
                ...
                @auth
                    @if(auth()->user()->currentWorkspace()?->mayring_active)
                        <a href="{{ route('mayring.memory') }}" wire:navigate
                           class="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('mayring.memory') ? 'bg-zinc-200/70 text-zinc-900 dark:bg-zinc-700/50 dark:text-zinc-100' : 'text-zinc-700 hover:bg-zinc-200/50 dark:text-zinc-300 dark:hover:bg-zinc-700/30' }}">
            ...
            {{-- Bottom links --}}
            <nav class="space-y-1">
                <a href="https://github.com/Nileneb/app.linn.games" target="_blank"
                   class="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-200/50 dark:text-zinc-300 dark:hover:bg-zinc-700/30">
                    <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-8.69-6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z"/></svg>
                    {{ __('Repository') }}
                </a>
                <a href="https://github.com/Nileneb/app.linn.games/wiki" target="_blank"
                   class="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-200/50 dark:text-zinc-300 dark:hover:bg-zinc-700/30">
